...
const ProductCard = (props) => {
  const { title, description, image, price, stock, setPopupProperties } = props;
  ...
  function addToCart() {
    setPopupProperties({title:"Success", description:"Added to cart!", type:"success"});
    console.log("Adicionei ao carrinho");
  }

  function notifyMe() {
    setPopupProperties({title:"Notify me", description:"Write your email!", type:"notify"});
    console.log("Notificar-me sobre o stock");
  }

  function addToWishlist() {
    toggleWishlist(!onWishlist);
    setPopupProperties({title:"Success", description:"Added to your wishlist!", type:"success"});
  ...
  return (
    <CardContainer>
      ...
      {/* {stock > 40 && <Button>Adicionar ao carrinho</Button>}
      {stock <= 40 && <Button>Notificar-me</Button>} */}
      <Button
